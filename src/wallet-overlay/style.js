...
export function getSandboxStyle({ uid } : {| uid : string |}) : string {
    return `
        ...
        #${ uid }.paypal-wallet-sandbox .paypal-wallet-sandbox-iframe {
            display: block;
            position: absolute;
            top: 0;
            left: 0;
...
export function getContainerStyle({ uid } : {| uid : string |}) : string {
    return `
        ...
        #${ uid } .paypal-wallet-close:before,
        #${ uid } .paypal-wallet-close:after {
        ...
        #${ uid }.paypal-overlay-loading .paypal-wallet-close {
            display: none;
        }

        #${ uid } .paypal-wallet-close:hover {
            opacity: 1;
        }

        #${ uid } .paypal-wallet-close:before, .paypal-wallet-close:after {
            position: absolute;
            left: 8px;
            content: ' ';
            height: 16px;
        ...
        #${ uid } .paypal-wallet-iframe-container {
            display: none;
        }

        #${ uid }.paypal-overlay-context-${ CONTEXT.IFRAME } .paypal-wallet-iframe-container,
        #${ uid }.paypal-overlay-context-${ CONTEXT.IFRAME } .paypal-wallet-iframe-container > .${ CLASS.OUTLET },
        #${ uid }.paypal-overlay-context-${ CONTEXT.IFRAME } .paypal-wallet-iframe-container > .${ CLASS.OUTLET } > iframe {
            max-height: 95vh;
            max-width: 95vw;
        }
